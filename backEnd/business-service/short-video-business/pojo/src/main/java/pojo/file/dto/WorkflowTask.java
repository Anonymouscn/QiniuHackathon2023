...
public class WorkflowTask
    ...
    public static WorkflowTask generateTask(File file) {
        return generateTask(file, "m3u8");
    }

    public static WorkflowTask generateTask(File file, String targetType) {
        return generateTask(file, "mp4", targetType);
    }

    public static WorkflowTask generateTask(File file, String convertType, String targetType) {
